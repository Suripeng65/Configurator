...
var BTimeField_default = /* @__PURE__ */ defineComponent({
	__name: "BTimeField",
	...
	emits: ["update:modelValue", "update:placeholder"],
	setup(__props) {
		const props = useDefaults(__props, "BTimeField");
		const modelValue = useModel(__props, "modelValue");
		const placeholderModel = useModel(__props, "placeholder");
		const computedId = useId$1(() => props.id, "time-field");
		...
		return (_ctx, _cache) => {
			return openBlock(), createBlock(unref(TimeFieldRoot_default), {
				id: unref(computedId),
				...
				"step-snapping": unref(props).stepSnapping,
				...
				dir: unref(props).dir,
				class: normalizeClass([computedRootClasses.value, "b-time-field form-control d-inline-flex align-items-center gap-0"])
			}, {
				default: withCtx(({ segments, isInvalid, modelValue: currentValue }) => [renderSlot(_ctx.$slots, "default", {
					...
					return openBlock(), createElementBlock(Fragment, { key: part }, [part === "literal" ? (openBlock(), createBlock(unref(TimeFieldInput_default), {
						key: 0,
						part,
						...
						_: 2
					}, 1032, ["part"])) : (openBlock(), createBlock(unref(TimeFieldInput_default), {
						key: 1,
						part,
...
//# sourceMappingURL=BTimeField-BSDaZogC.mjs.map