...
import { a as upperFirst } from "./stringUtils-D4eEDlt1.mjs";
import { t as useAriaInvalid } from "./useAriaInvalid-apOwgexm.mjs";
import { t as useStateClass } from "./useStateClass-DxlL_m2E.mjs";
import { t as BCol_default } from "./BCol-B3VeEk9z.mjs";
import { a as useProvideFormGroupData, i as BFormInvalidFeedback_default, n as BFormText_default, r as BFormRow_default, t as BFormValidFeedback_default } from "./BFormValidFeedback-CBYxQLDz.mjs";
	...
	setup(__props) {
		...
		return (_ctx, _cache) => {
			return openBlock(), createElementBlock("fieldset", mergeProps({
				...
				_: 3
			})) : (openBlock(), createElementBlock(Fragment, { key: 1 }, [unref(props).floating && !isHorizontal.value ? (openBlock(), createElementBlock("div", _hoisted_2, [
...
//# sourceMappingURL=BFormGroup-vysRPb99.mjs.map