import { d as formGroupKey, s as checkboxGroupKey } from "./keys-DU7sQgl3.mjs";
	...
	setup(__props, { expose: __expose }) {
		...
		return (_ctx, _cache) => {
			return openBlock(), createBlock(ConditionalWrapper_default, mergeProps({ skip: isButtonGroup.value }, unref(props).wrapperAttrs, { class: computedWrapperClasses.value }), {
				...
				}, processedAttrs.value.inputAttrs), null, 16, _hoisted_1$1), [[vModelCheckbox, localValue.value]]), hasOwnLabel.value ? (openBlock(), createElementBlock("label", {
					key: 0,
...
//# sourceMappingURL=BFormCheckbox-Baf_9BSc.mjs.map