...
var BCol_default = /* @__PURE__ */ (0, vue.defineComponent)({
	__name: "BCol",
	props: {
	...
	setup(__props) {
		const props = require_useDefaults.useDefaults(__props, "BCol");
		const classList = (0, vue.computed)(() => [
			...require_getClasses.getClasses({
				sm: props.sm,
				md: props.md,
				lg: props.lg,
				xl: props.xl,
		...
		const computedClasses = (0, vue.computed)(() => [classList.value, {
...
//#endregion
Object.defineProperty(exports, "BCol_default", {
	enumerable: true,
	get: function() {
		return BCol_default;
	}
...
//# sourceMappingURL=BCol-Ck9VydHj.js.map