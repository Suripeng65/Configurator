import { c as collapseInjectionKey, g as navbarInjectionKey } from "./keys-DU7sQgl3.mjs";
import { t as useDefaults } from "./useDefaults-DseelK6y.mjs";
import { a as pick } from "./object-CHQkkner.mjs";
import { i as toPascalCase } from "./stringUtils-D4eEDlt1.mjs";
import { computed, createBlock, defineComponent, getCurrentInstance, inject, mergeProps, openBlock, readonly, renderSlot, resolveDynamicComponent, toRef, toValue, unref, useAttrs, withCtx } from "vue";
...
var useBLinkTagResolver = ({ to, disabled, href, replace, routerComponentName }) => {
	...
	const isNuxtLink = computed(() => typeof instance?.appContext?.app?.$nuxt !== "undefined");
...
//#endregion
export { useLinkClasses as n, useBLinkHelper as r, BLink_default as t };

//# sourceMappingURL=BLink-Dfgte6dQ.mjs.map