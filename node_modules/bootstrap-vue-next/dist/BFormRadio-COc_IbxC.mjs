import { d as formGroupKey, y as radioGroupKey } from "./keys-DU7sQgl3.mjs";
	...
	setup(__props, { expose: __expose }) {
		...
		return (_ctx, _cache) => {
			return openBlock(), createBlock(ConditionalWrapper_default, {
				...
				}), null, 16, _hoisted_1$1), [[vModelRadio, localValue.value]]), hasOwnLabel.value ? (openBlock(), createElementBlock("label", {
					key: 0,
...
//# sourceMappingURL=BFormRadio-COc_IbxC.mjs.map