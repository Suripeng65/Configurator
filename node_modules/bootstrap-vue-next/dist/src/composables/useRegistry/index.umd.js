...
var useRegistry = (rtl = false) => {
	if (!(0, vue.inject)(require_keys.showHideRegistryKey, null)) {
		const { register, values } = _newShowHideRegistry();
		(0, vue.provide)(require_keys.showHideRegistryKey, {
			register,
			values
		});
	}
	if (!(0, vue.inject)(require_keys.modalManagerKey, null)) {
		...
		*/
		...
		(0, vue.provide)(require_keys.modalManagerKey, {
			countStack,
			lastStack,
	...
	if (!(0, vue.inject)(require_keys.breadcrumbRegistryKey, null)) {
		const items = (0, vue.ref)({ [require_keys.breadcrumbGlobalIndexKey]: [] });
		const reset = (key = require_keys.breadcrumbGlobalIndexKey) => {
			items.value[key] = [];
		};
		(0, vue.provide)(require_keys.breadcrumbRegistryKey, {
			items,
			reset
		});
	}
	if (!(0, vue.inject)(require_keys.rtlRegistryKey, null)) {
