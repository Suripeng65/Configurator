	...
	Object.assign(promise, {
		...
		set(val) {
			...
			if (item) {
				...
				const updatedItem = {
					...v,
					modelValue: (0, vue.toValue)(v.modelValue)
				};
				const vRecord = v;
				if ("title" in vRecord && vRecord.title !== void 0) updatedItem.title = (0, vue.toValue)(vRecord.title);
				if ("body" in vRecord && vRecord.body !== void 0) updatedItem.body = (0, vue.toValue)(vRecord.body);
...
var _newOrchestratorRegistry = () => ({
	store: (0, vue.ref)([]),
	_isOrchestratorInstalled: (0, vue.ref)(false),
	_isToastAppend: (0, vue.ref)(false)
});
var useOrchestratorRegistry = () => {
	...
	(0, vue.provide)(require_keys.orchestratorRegistryKey, newOrchestratorRegistry);
	return newOrchestratorRegistry;
};
//#endregion
exports._newOrchestratorRegistry = _newOrchestratorRegistry;
exports.buildPromise = buildPromise;
exports.useOrchestratorRegistry = useOrchestratorRegistry;
