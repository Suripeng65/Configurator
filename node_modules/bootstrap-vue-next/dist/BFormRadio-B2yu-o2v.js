...
var BFormRadio_default = /* @__PURE__ */ (0, vue.defineComponent)({
	inheritAttrs: false,
	__name: "BFormRadio",
	...
	setup(__props, { expose: __expose }) {
		const props = require_useDefaults.useDefaults(__props, "BFormRadio");
		const slots = (0, vue.useSlots)();
		const modelValue = (0, vue.useModel)(__props, "modelValue");
		const computedId = require_useId.useId(() => props.id, "form-check");
		const parentData = (0, vue.inject)(require_keys.radioGroupKey, null);
		...
		const hasOwnLabel = (0, vue.computed)(() => hasDefaultSlot.value || !resolvedPlain.value);
		const labelTargetId = (0, vue.computed)(() => hasOwnLabel.value ? null : computedId.value);
		const formGroupData = (0, vue.inject)(require_keys.formGroupKey, null)?.();
		...
		const computedClasses = require_useFormCheck.getClasses(classesObject);
		...
		return (_ctx, _cache) => {
			return (0, vue.openBlock)(), (0, vue.createBlock)(require_ConditionalWrapper.ConditionalWrapper_default, {
				...
				class: (0, vue.normalizeClass)((0, vue.unref)(computedClasses))
			}, {
				default: (0, vue.withCtx)(() => [(0, vue.withDirectives)((0, vue.createElementVNode)("input", (0, vue.mergeProps)({ id: (0, vue.unref)(computedId) }, _ctx.$attrs, {
					ref: "_input",
					"onUpdate:modelValue": _cache[0] || (_cache[0] = ($event) => localValue.value = $event),
					class: (0, vue.unref)(inputClasses),
					type: "radio",
				...
				}), null, 16, _hoisted_1$1), [[vue.vModelRadio, localValue.value]]), hasOwnLabel.value ? ((0, vue.openBlock)(), (0, vue.createElementBlock)("label", {
					key: 0,
...
var BFormRadioGroupBase_default = /* @__PURE__ */ (0, vue.defineComponent)({
	...
	emits: ["update:modelValue"],
	setup(__props, { expose: __expose }) {
		const props = require_useDefaults.useDefaults(__props, "BFormRadioGroup");
		const modelValue = (0, vue.useModel)(__props, "modelValue");
		const computedId = require_useId.useId(() => props.id, "radio");
		const computedName = require_useId.useId(() => props.name, "radio");
		const { focused } = require_dist.useFocus((0, vue.useTemplateRef)("_element"), { initialValue: props.autofocus });
		...
		const computedAttrs = require_useFormCheck.getGroupAttr(classesObject);
		const computedClasses = require_useFormCheck.getGroupClasses(classesObject);
		__expose({
			blur: () => {
				focused.value = false;
			},
		...
		return (_ctx, _cache) => {
			return (0, vue.openBlock)(), (0, vue.createElementBlock)("div", (0, vue.mergeProps)((0, vue.unref)(computedAttrs), {
				id: (0, vue.unref)(computedId),
				ref: "_element",
				role: "radiogroup",
				class: [(0, vue.unref)(computedClasses), "bv-no-focus-ring"],
				tabindex: "-1"
			}), [
				...
				((0, vue.openBlock)(true), (0, vue.createElementBlock)(vue.Fragment, null, (0, vue.renderList)(normalizedOptions.value, (item, index) => {
					return (0, vue.openBlock)(), (0, vue.createBlock)(BFormRadio_default, (0, vue.mergeProps)({ key: index }, { ref_for: true }, item), {
...
var BFormRadioGroup_default = /* @__PURE__ */ (0, vue.defineComponent)({
	...
	setup(__props) {
		...
		return (_ctx, _cache) => {
			return (0, vue.openBlock)(), (0, vue.createBlock)(BFormRadioGroupBase_default, (0, vue.mergeProps)(forwardedProps.value, {
...
//#endregion
Object.defineProperty(exports, "BFormRadioGroup_default", {
	enumerable: true,
	get: function() {
		return BFormRadioGroup_default;
	}
});
Object.defineProperty(exports, "BFormRadio_default", {
	enumerable: true,
	get: function() {
		return BFormRadio_default;
	}
});

//# sourceMappingURL=BFormRadio-B2yu-o2v.js.map