...
import { t as BImg_default } from "./BImg-QBS2ECBc.mjs";
import { computed, createBlock, createCommentVNode, createTextVNode, defineComponent, mergeProps, normalizeClass, normalizeProps, openBlock, renderSlot, resolveDynamicComponent, toDisplayString, unref, useSlots, withCtx } from "vue";
//#endregion
	...
	setup(__props) {
		...
		return (_ctx, _cache) => {
			return openBlock(), createBlock(resolveDynamicComponent(unref(props).tag), { class: normalizeClass(["card", computedClasses.value]) }, {
				default: withCtx(() => [
					unref(props).imgPlacement !== "bottom" ? renderSlot(_ctx.$slots, "img", { key: 0 }, () => [unref(props).imgSrc ? (openBlock(), createBlock(BCardImg_default, normalizeProps(mergeProps({ key: 0 }, imgAttr.value)), null, 16)) : createCommentVNode("", true)]) : createCommentVNode("", true),
					...
					unref(props).imgPlacement === "bottom" ? renderSlot(_ctx.$slots, "img", { key: 5 }, () => [unref(props).imgSrc ? (openBlock(), createBlock(BCardImg_default, normalizeProps(mergeProps({ key: 0 }, imgAttr.value)), null, 16)) : createCommentVNode("", true)]) : createCommentVNode("", true)
				]),
				_: 3
			}, 8, ["class"]);
		};
...
//# sourceMappingURL=BCard-CHbKv2OR.mjs.map