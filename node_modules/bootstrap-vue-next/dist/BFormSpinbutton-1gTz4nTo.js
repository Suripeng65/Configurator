...
const require_useRtl = require("./useRtl-BSgvbs5F.js");
let vue = require("vue");
...
var BFormSpinbutton_default = /* @__PURE__ */ (0, vue.defineComponent)({
	...
	setup(__props, { emit: __emit }) {
		const KEY_CODES = [
			require_constants.CODE_UP,
			require_constants.CODE_DOWN,
			require_constants.CODE_HOME,
			"End",
			require_constants.CODE_PAGEUP,
			require_constants.CODE_PAGEDOWN
		];
		const props = require_useDefaults.useDefaults(__props, "BFormSpinbutton");
		const emit = __emit;
		const modelValue = (0, vue.useModel)(__props, "modelValue");
		const element = (0, vue.useTemplateRef)("_element");
		const { focused } = require_dist.useFocus(element);
		const computedId = require_useId.useId(() => props.id, "spinbutton");
		...
		const computedSpinClasses = (0, vue.computed)(() => ({
		...
		const stepNumber = require_dist.useToNumber(() => props.step);
		const computedStep = (0, vue.computed)(() => Number.isNaN(stepNumber.value) ? defaultValues.step : stepNumber.value);
		const minNumber = require_dist.useToNumber(() => props.min);
		const computedMin = (0, vue.computed)(() => Number.isNaN(minNumber.value) ? defaultValues.min : minNumber.value);
		const maxNumber = require_dist.useToNumber(() => props.max);
		const computedMax = (0, vue.computed)(() => {
			const step = computedStep.value;
			const min = computedMin.value;
			return Math.floor((maxNumber.value - min) / step) * step + min;
		});
		const repeatDelayNumber = require_dist.useToNumber(() => props.repeatDelay, {
			nanToZero: true,
			method: "parseInt"
		});
		const computedDelay = (0, vue.computed)(() => repeatDelayNumber.value > 0 ? repeatDelayNumber.value : defaultValues.repeatDelay);
		const repeatIntervalNumber = require_dist.useToNumber(() => props.repeatInterval, {
			nanToZero: true,
			method: "parseInt"
		});
		const computedInterval = (0, vue.computed)(() => repeatIntervalNumber.value > 0 ? repeatIntervalNumber.value : defaultValues.repeatInterval);
		const repeatThresholdNumber = require_dist.useToNumber(() => props.repeatThreshold, {
			nanToZero: true,
			method: "parseInt"
		});
		const computedThreshold = (0, vue.computed)(() => Math.max(Number.isNaN(repeatThresholdNumber.value) ? defaultValues.repeatThreshold : repeatThresholdNumber.value, 1));
		const repeatStepMultiplierNumber = require_dist.useToNumber(() => props.repeatStepMultiplier, {
			nanToZero: true,
			method: "parseInt"
		});
		const computedStepMultiplier = (0, vue.computed)(() => Math.max(Number.isNaN(repeatStepMultiplierNumber.value) ? defaultValues.repeatMultiplier : repeatStepMultiplierNumber.value, 1));
		const computedPrecision = (0, vue.computed)(() => {
			const step = computedStep.value;
			return Math.floor(step) === step ? 0 : (step.toString().split(".")[1] || "").length;
		});
		const computedMultiplier = (0, vue.computed)(() => Math.pow(10, computedPrecision.value || 0));
		const valueAsFixed = (0, vue.computed)(() => modelValue.value === null ? "" : modelValue.value.toFixed(computedPrecision.value));
		...
		const computedFormatter = (0, vue.computed)(() => props.formatterFn ?? defaultFormatter());
		...
		require_dist.onKeyStroke(KEY_CODES, (event) => {
		...
		return (_ctx, _cache) => {
			return (0, vue.openBlock)(), (0, vue.createElementBlock)("div", {
				ref: "_element",
				class: (0, vue.normalizeClass)(["b-form-spinbutton form-control", computedClasses.value]),
				role: "group",
				lang: computedLocale.value,
				tabindex: (0, vue.unref)(props).disabled ? void 0 : "-1",
				title: (0, vue.unref)(props).ariaLabel,
				onClick: _cache[4] || (_cache[4] = ($event) => focused.value = true)
			}, [
				(0, vue.renderSlot)(_ctx.$slots, buttons.value.top.slot.name, { hasFocus: (0, vue.unref)(focused) }, () => [(0, vue.createElementVNode)("button", (0, vue.mergeProps)(buttons.value.top.button, {
				...
				}), [((0, vue.openBlock)(), (0, vue.createElementBlock)("svg", (0, vue.normalizeProps)((0, vue.guardReactiveProps)(buttons.value.top.svg)), [(0, vue.createElementVNode)("path", (0, vue.normalizeProps)((0, vue.guardReactiveProps)(buttons.value.top.path)), null, 16)], 16))], 16)]),
				...
				(0, vue.createElementVNode)("output", {
					...
					key: "output",
					class: (0, vue.normalizeClass)(["flex-grow-1", computedSpinClasses.value]),
					dir: (0, vue.unref)(isRtl) ?? false ? "rtl" : "ltr",
					tabindex: (0, vue.unref)(props).disabled ? void 0 : "0",
					role: "spinbutton",
					"aria-live": "off",
					"aria-label": (0, vue.unref)(props).ariaLabel || void 0,
					"aria-invalid": (0, vue.unref)(props).state === false || !modelValue.value !== null && (0, vue.unref)(props).required ? true : void 0,
					"aria-required": (0, vue.unref)(props).required ? true : void 0,
				...
				}, [(0, vue.createElementVNode)("bdi", null, (0, vue.toDisplayString)((modelValue.value !== null ? computedFormatter.value(modelValue.value) : (0, vue.unref)(props).placeholder) || ""), 1)], 10, _hoisted_3),
				(0, vue.renderSlot)(_ctx.$slots, buttons.value.bottom.slot.name, { hasFocus: (0, vue.unref)(focused) }, () => [(0, vue.createElementVNode)("button", (0, vue.mergeProps)(buttons.value.bottom.button, {
				...
				}), [((0, vue.openBlock)(), (0, vue.createElementBlock)("svg", (0, vue.normalizeProps)((0, vue.guardReactiveProps)(buttons.value.bottom.svg)), [(0, vue.createElementVNode)("path", (0, vue.normalizeProps)((0, vue.guardReactiveProps)(buttons.value.bottom.path)), null, 16)], 16))], 16)])
			], 10, _hoisted_1);
		};
	}
});
//#endregion
Object.defineProperty(exports, "BFormSpinbutton_default", {
	enumerable: true,
	get: function() {
		return BFormSpinbutton_default;
	}
});

//# sourceMappingURL=BFormSpinbutton-1gTz4nTo.js.map