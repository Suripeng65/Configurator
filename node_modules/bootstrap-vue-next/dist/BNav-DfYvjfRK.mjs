...
import { t as BLink_default } from "./BLink-Dfgte6dQ.mjs";
import { t as useAlignment } from "./useAlignment-DuR8ymKI.mjs";
import { t as BDropdown_default } from "./BDropdown-B1DbvVzm.mjs";
import { t as BForm_default } from "./BForm-BVfW08s5.mjs";
...
var BNav_default = /* @__PURE__ */ defineComponent({
	__name: "BNav",
	props: {
	...
	setup(__props) {
		const props = useDefaults(__props, "BNav");
		...
		return (_ctx, _cache) => {
			return openBlock(), createBlock(resolveDynamicComponent(unref(props).tag), { class: normalizeClass(["nav", computedClasses.value]) }, {
...
var BNavForm_default = /* @__PURE__ */ defineComponent({
	inheritAttrs: false,
	__name: "BNavForm",
	props: {
		role: { default: void 0 },
	...
	setup(__props, { emit: __emit }) {
		const props = useDefaults(__props, "BNavForm");
		const emit = __emit;
		...
		return (_ctx, _cache) => {
			return openBlock(), createElementBlock("li", mergeProps({ class: liClasses.value }, __props.wrapperAttrs), [createVNode(BForm_default, mergeProps(processedAttrs.value.formAttrs, {
				id: unref(props).id,
...
var BNavItem_default = /* @__PURE__ */ defineComponent({
	__name: "BNavItem",
	props: {
	...
	emits: ["click"],
	setup(__props, { emit: __emit }) {
		const props = useDefaults(__props, "BNavItem");
		const emit = __emit;
		const computedLinkProps = computed(() => pick(props, [
			"active",
			"activeClass",
			"disabled",
			"exactActiveClass",
		...
		return (_ctx, _cache) => {
			return openBlock(), createElementBlock("li", _hoisted_1$2, [createVNode(BLink_default, mergeProps({
...
var BNavItemDropdown_default = /* @__PURE__ */ defineComponent({
	...
	setup(__props, { expose: __expose, emit: __emit }) {
		const props = useDefaults(__props, "BNavItemDropdown");
		const emit = __emit;
		...
		return (_ctx, _cache) => {
			return openBlock(), createElementBlock("li", _hoisted_1$1, [createVNode(BDropdown_default, mergeProps({ ref: "_dropdown" }, unref(props), {
...
var BNavText_default = /* @__PURE__ */ defineComponent({
	__name: "BNavText",
	props: { text: { default: void 0 } },
	setup(__props) {
		const props = useDefaults(__props, "BNavText");
		return (_ctx, _cache) => {
			return openBlock(), createElementBlock("li", _hoisted_1, [renderSlot(_ctx.$slots, "default", {}, () => [createTextVNode(toDisplayString(unref(props).text), 1)])]);
		};
	}
});
//#endregion
...
//# sourceMappingURL=BNav-DfYvjfRK.mjs.map