...
import { Fragment, computed, createBlock, createElementBlock, createElementVNode, createTextVNode, createVNode, defineComponent, mergeModels, mergeProps, nextTick, normalizeClass, onMounted, openBlock, ref, renderList, renderSlot, toDisplayString, toHandlers, toRefs, unref, useModel, watch, withCtx, withKeys } from "vue";
...
var [injectTimeRangeFieldRootContext, provideTimeRangeFieldRootContext] = createContext("TimeRangeFieldRoot");
...
var TimeRangeFieldRoot_default = /* @__PURE__ */ defineComponent({
	...
	setup(__props, { expose: __expose, emit: __emit }) {
		...
		const convertedStartValue = computed({
			...
			set(newValue) {
				if (newValue) startValue.value = startValue.value && "day" in startValue.value ? newValue : new $35ea8db9cb2ccb90$export$680ea196effce5f(newValue.hour, newValue.minute, newValue.second, startValue.value?.millisecond);
		...
		const convertedEndValue = computed({
			...
			set(newValue) {
				if (newValue) endValue.value = endValue.value && "day" in endValue.value ? newValue : new $35ea8db9cb2ccb90$export$680ea196effce5f(newValue.hour, newValue.minute, newValue.second, endValue.value?.millisecond);
...
var BDateField_default = /* @__PURE__ */ defineComponent({
	__name: "BDateField",
	...
	emits: ["update:modelValue", "update:placeholder"],
	setup(__props) {
		const props = useDefaults(__props, "BDateField");
		const modelValue = useModel(__props, "modelValue");
		const placeholderModel = useModel(__props, "placeholder");
		const computedId = useId$1(() => props.id, "date-field");
		...
		return (_ctx, _cache) => {
			return openBlock(), createBlock(unref(DateFieldRoot_default), {
				id: unref(computedId),
				...
				class: normalizeClass([computedRootClasses.value, "b-date-field form-control d-inline-flex align-items-center gap-0"])
			}, {
				default: withCtx(({ segments, isInvalid, modelValue: currentValue }) => [renderSlot(_ctx.$slots, "default", {
					modelValue: currentValue,
					segments,
					isInvalid
				}, () => [(openBlock(true), createElementBlock(Fragment, null, renderList(segments, ({ part, value }) => {
					return openBlock(), createElementBlock(Fragment, { key: part }, [part === "literal" ? (openBlock(), createBlock(unref(DateFieldInput_default), {
						key: 0,
						part,
						...
						_: 2
					}, 1032, ["part"])) : (openBlock(), createBlock(unref(DateFieldInput_default), {
						key: 1,
						part,
...
var BDateRangeField_default = /* @__PURE__ */ defineComponent({
	...
	emits: ["update:modelValue", "update:placeholder"],
	setup(__props) {
		const props = useDefaults(__props, "BDateRangeField");
		const modelValue = useModel(__props, "modelValue");
		const placeholderModel = useModel(__props, "placeholder");
		const computedId = useId$1(() => props.id, "date-range-field");
		const computedRootClasses = computed(() => ({
			"disabled": props.disabled,
			"readonly": props.readonly,
			"is-valid": props.state === true,
		...
		return (_ctx, _cache) => {
			return openBlock(), createBlock(unref(DateRangeFieldRoot_default), {
				id: unref(computedId),
				modelValue: modelValue.value,
				"onUpdate:modelValue": _cache[0] || (_cache[0] = ($event) => modelValue.value = $event),
				placeholder: placeholderModel.value,
				...
				dir: unref(props).dir,
				"is-date-unavailable": unref(props).isDateUnavailable,
				class: normalizeClass([computedRootClasses.value, "b-date-range-field form-control d-inline-flex align-items-center gap-0"])
			}, {
				default: withCtx(({ segments, isInvalid, modelValue: currentValue }) => [renderSlot(_ctx.$slots, "default", {
					modelValue: currentValue,
					segments,
					...
					(openBlock(true), createElementBlock(Fragment, null, renderList(segments.start, ({ part, value }) => {
						return openBlock(), createElementBlock(Fragment, { key: `start-${part}` }, [part === "literal" ? (openBlock(), createBlock(unref(DateRangeFieldInput_default), {
							key: 0,
							type: "start",
							part,
							...
							default: withCtx(() => [createTextVNode(toDisplayString(value), 1)]),
							_: 2
						}, 1032, ["part"])) : (openBlock(), createBlock(unref(DateRangeFieldInput_default), {
							key: 1,
							type: "start",
							part,
					...
					(openBlock(true), createElementBlock(Fragment, null, renderList(segments.end, ({ part, value }) => {
						return openBlock(), createElementBlock(Fragment, { key: `end-${part}` }, [part === "literal" ? (openBlock(), createBlock(unref(DateRangeFieldInput_default), {
							key: 0,
							type: "end",
							part,
							class: "b-date-range-field-literal"
...
var BTimeRangeField_default = /* @__PURE__ */ defineComponent({
	...
	emits: ["update:modelValue", "update:placeholder"],
	setup(__props) {
		const props = useDefaults(__props, "BTimeRangeField");
		const modelValue = useModel(__props, "modelValue");
		const placeholderModel = useModel(__props, "placeholder");
		const computedId = useId$1(() => props.id, "time-range-field");
		const computedRootClasses = computed(() => ({
			"disabled": props.disabled,
			"readonly": props.readonly,
			"is-valid": props.state === true,
		...
		return (_ctx, _cache) => {
			return openBlock(), createBlock(unref(TimeRangeFieldRoot_default), {
				id: unref(computedId),
				modelValue: modelValue.value,
				"onUpdate:modelValue": _cache[0] || (_cache[0] = ($event) => modelValue.value = $event),
				placeholder: placeholderModel.value,
				...
				required: unref(props).required,
				dir: unref(props).dir,
				"is-time-unavailable": unref(props).isTimeUnavailable,
				class: normalizeClass([computedRootClasses.value, "b-time-range-field form-control d-inline-flex align-items-center gap-0"])
			}, {
				default: withCtx(({ segments, isInvalid, modelValue: currentValue }) => [renderSlot(_ctx.$slots, "default", {
					modelValue: currentValue,
					segments,
					...
					(openBlock(true), createElementBlock(Fragment, null, renderList(segments.start, ({ part, value }) => {
						return openBlock(), createElementBlock(Fragment, { key: `start-${part}` }, [part === "literal" ? (openBlock(), createBlock(unref(TimeRangeFieldInput_default), {
							key: 0,
							type: "start",
							part,
							...
							default: withCtx(() => [createTextVNode(toDisplayString(value), 1)]),
							_: 2
						}, 1032, ["part"])) : (openBlock(), createBlock(unref(TimeRangeFieldInput_default), {
							key: 1,
							type: "start",
							part,
					...
					(openBlock(true), createElementBlock(Fragment, null, renderList(segments.end, ({ part, value }) => {
						return openBlock(), createElementBlock(Fragment, { key: `end-${part}` }, [part === "literal" ? (openBlock(), createBlock(unref(TimeRangeFieldInput_default), {
							key: 0,
							type: "end",
							part,
							class: "b-time-range-field-literal"
...
//#endregion
export { BDateRangeField_default as n, BDateField_default as r, BTimeRangeField_default as t };

//# sourceMappingURL=BDateField-CccP3H1R.mjs.map