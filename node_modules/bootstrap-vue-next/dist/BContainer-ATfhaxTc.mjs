...
import "./BCol-B3VeEk9z.mjs";
import "./BRow-eGSUYGCW.mjs";
...
var BContainer_default = /* @__PURE__ */ defineComponent({
	__name: "BContainer",
	props: {
		fluid: {
			type: [Boolean, String],
	...
	setup(__props) {
		const props = useDefaults(__props, "BContainer");
...
//#endregion
export { BContainer_default as t };

//# sourceMappingURL=BContainer-ATfhaxTc.mjs.map