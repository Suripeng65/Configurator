...
let vue = require("vue");
//#region ../../node_modules/.pnpm/reka-ui@2.9.2_vue@3.5.31_typescript@5.9.3_/node_modules/reka-ui/dist/TimeRangeField/TimeRangeFieldRoot.js
var [injectTimeRangeFieldRootContext, provideTimeRangeFieldRootContext] = require_VisuallyHidden.createContext("TimeRangeFieldRoot");
...
var TimeRangeFieldRoot_default = /* @__PURE__ */ (0, vue.defineComponent)({
	inheritAttrs: false,
	...
	setup(__props, { expose: __expose, emit: __emit }) {
		...
		const isStartInvalid = (0, vue.computed)(() => {
			...
			if (convertedMinValue.value && require_useDateField.isBefore(convertedStartValue$1, convertedMinValue.value)) return true;
			if (convertedMaxValue.value && require_useDateField.isBefore(convertedMaxValue.value, convertedStartValue$1)) return true;
			return false;
		});
		const isEndInvalid = (0, vue.computed)(() => {
			...
			if (convertedMinValue.value && require_useDateField.isBefore(convertedEndValue$1, convertedMinValue.value)) return true;
			if (convertedMaxValue.value && require_useDateField.isBefore(convertedMaxValue.value, convertedEndValue$1)) return true;
			return false;
		});
		const isInvalid = (0, vue.computed)(() => {
			...
			if (!require_useDateField.isBeforeOrSame(convertedModelValue$1.start, convertedModelValue$1.end)) return true;
			if (propsIsTimeUnavailable.value !== void 0) {
				if (!require_useDateField.areAllDaysBetweenValid(convertedModelValue$1.start, convertedModelValue$1.end, propsIsTimeUnavailable.value, void 0)) return true;
			}
			return false;
		});
		...
		const convertedStartValue = (0, vue.computed)({
			get() {
				if (require_useKbd.isNullish(startValue.value)) return startValue.value;
				return convertValue(startValue.value);
			},
			set(newValue) {
				if (newValue) startValue.value = startValue.value && "day" in startValue.value ? newValue : new require_useDateField.$35ea8db9cb2ccb90$export$680ea196effce5f(newValue.hour, newValue.minute, newValue.second, startValue.value?.millisecond);
		...
		const convertedEndValue = (0, vue.computed)({
			get() {
				if (require_useKbd.isNullish(endValue.value)) return endValue.value;
				return convertValue(endValue.value);
			},
			set(newValue) {
				if (newValue) endValue.value = endValue.value && "day" in endValue.value ? newValue : new require_useDateField.$35ea8db9cb2ccb90$export$680ea196effce5f(newValue.hour, newValue.minute, newValue.second, endValue.value?.millisecond);
		...
		const startSegmentValues = (0, vue.ref)(convertedStartValue.value ? { ...require_useDateField.syncTimeSegmentValues({
			value: convertedStartValue.value,
			formatter
		}) } : { ...initialSegments });
		const endSegmentValues = (0, vue.ref)(convertedEndValue.value ? { ...require_useDateField.syncTimeSegmentValues({
			value: convertedEndValue.value,
			formatter
		}) } : { ...initialSegments });
		const startSegmentContent = (0, vue.computed)(() => require_useDateField.createContent({
		...
		const endSegmentContent = (0, vue.computed)(() => require_useDateField.createContent({
			granularity: inferredGranularity.value,
			dateRef: convertedPlaceholder.value,
			formatter,
			hideTimeZone: props.hideTimeZone,
		...
		(0, vue.watch)([convertedStartValue, locale], ([_startValue]) => {
			if (_startValue !== void 0) startSegmentValues.value = { ...require_useDateField.syncSegmentValues({
				value: _startValue,
				formatter
			}) };
		...
		(0, vue.watch)([convertedEndValue, locale], ([_endValue]) => {
			if (_endValue !== void 0) endSegmentValues.value = { ...require_useDateField.syncSegmentValues({
				value: _endValue,
				formatter
			}) };
...
//#endregion
//#region ../../node_modules/.pnpm/reka-ui@2.9.2_vue@3.5.31_typescript@5.9.3_/node_modules/reka-ui/dist/TimeRangeField/TimeRangeFieldInput.js
var TimeRangeFieldInput_default = /* @__PURE__ */ (0, vue.defineComponent)({
	...
	setup(__props) {
		...
		const { handleSegmentClick, handleSegmentKeydown, attributes } = require_useDateField.useDateField({
			hasLeftFocus,
...
//#endregion
//#region src/components/BDateField/BDateField.vue
var BDateField_default = /* @__PURE__ */ (0, vue.defineComponent)({
	__name: "BDateField",
	...
	emits: ["update:modelValue", "update:placeholder"],
	setup(__props) {
		const props = require_useDefaults.useDefaults(__props, "BDateField");
		const modelValue = (0, vue.useModel)(__props, "modelValue");
		const placeholderModel = (0, vue.useModel)(__props, "placeholder");
		const computedId = require_useId.useId(() => props.id, "date-field");
		...
		return (_ctx, _cache) => {
			return (0, vue.openBlock)(), (0, vue.createBlock)((0, vue.unref)(require_DateRangeFieldInput.DateFieldRoot_default), {
				...
				class: (0, vue.normalizeClass)([computedRootClasses.value, "b-date-field form-control d-inline-flex align-items-center gap-0"])
			}, {
				default: (0, vue.withCtx)(({ segments, isInvalid, modelValue: currentValue }) => [(0, vue.renderSlot)(_ctx.$slots, "default", {
					...
					return (0, vue.openBlock)(), (0, vue.createElementBlock)(vue.Fragment, { key: part }, [part === "literal" ? ((0, vue.openBlock)(), (0, vue.createBlock)((0, vue.unref)(require_DateRangeFieldInput.DateFieldInput_default), {
						key: 0,
						part,
						class: "b-date-field-literal"
					}, {
						default: (0, vue.withCtx)(() => [(0, vue.createTextVNode)((0, vue.toDisplayString)(value), 1)]),
						_: 2
					}, 1032, ["part"])) : ((0, vue.openBlock)(), (0, vue.createBlock)((0, vue.unref)(require_DateRangeFieldInput.DateFieldInput_default), {
						key: 1,
						part,
						class: "b-date-field-segment"
					}, {
						default: (0, vue.withCtx)(() => [(0, vue.createTextVNode)((0, vue.toDisplayString)(value), 1)]),
						_: 2
					}, 1032, ["part"]))], 64);
...
//#endregion
//#region src/components/BDateField/BDateRangeField.vue
var BDateRangeField_default = /* @__PURE__ */ (0, vue.defineComponent)({
	__name: "BDateRangeField",
	props: /* @__PURE__ */ (0, vue.mergeModels)({
		defaultPlaceholder: { default: void 0 },
		defaultValue: { default: void 0 },
		dir: { default: void 0 },
	...
	emits: ["update:modelValue", "update:placeholder"],
	setup(__props) {
		const props = require_useDefaults.useDefaults(__props, "BDateRangeField");
		const modelValue = (0, vue.useModel)(__props, "modelValue");
		const placeholderModel = (0, vue.useModel)(__props, "placeholder");
		const computedId = require_useId.useId(() => props.id, "date-range-field");
		const computedRootClasses = (0, vue.computed)(() => ({
			"disabled": props.disabled,
			"readonly": props.readonly,
			"is-valid": props.state === true,
		...
		return (_ctx, _cache) => {
			return (0, vue.openBlock)(), (0, vue.createBlock)((0, vue.unref)(require_DateRangeFieldInput.DateRangeFieldRoot_default), {
				id: (0, vue.unref)(computedId),
				modelValue: modelValue.value,
				"onUpdate:modelValue": _cache[0] || (_cache[0] = ($event) => modelValue.value = $event),
				placeholder: placeholderModel.value,
				...
				dir: (0, vue.unref)(props).dir,
				"is-date-unavailable": (0, vue.unref)(props).isDateUnavailable,
				class: (0, vue.normalizeClass)([computedRootClasses.value, "b-date-range-field form-control d-inline-flex align-items-center gap-0"])
			}, {
				default: (0, vue.withCtx)(({ segments, isInvalid, modelValue: currentValue }) => [(0, vue.renderSlot)(_ctx.$slots, "default", {
					modelValue: currentValue,
					segments,
					...
					((0, vue.openBlock)(true), (0, vue.createElementBlock)(vue.Fragment, null, (0, vue.renderList)(segments.start, ({ part, value }) => {
						return (0, vue.openBlock)(), (0, vue.createElementBlock)(vue.Fragment, { key: `start-${part}` }, [part === "literal" ? ((0, vue.openBlock)(), (0, vue.createBlock)((0, vue.unref)(require_DateRangeFieldInput.DateRangeFieldInput_default), {
							key: 0,
							type: "start",
							part,
							...
							default: (0, vue.withCtx)(() => [(0, vue.createTextVNode)((0, vue.toDisplayString)(value), 1)]),
							_: 2
						}, 1032, ["part"])) : ((0, vue.openBlock)(), (0, vue.createBlock)((0, vue.unref)(require_DateRangeFieldInput.DateRangeFieldInput_default), {
							key: 1,
							type: "start",
							part,
							class: "b-date-range-field-segment"
						}, {
							default: (0, vue.withCtx)(() => [(0, vue.createTextVNode)((0, vue.toDisplayString)(value), 1)]),
							_: 2
						}, 1032, ["part"]))], 64);
					...
					_cache[2] || (_cache[2] = (0, vue.createElementVNode)("span", {
						class: "b-date-range-field-separator",
						"aria-hidden": "true"
					}, " – ", -1)),
					((0, vue.openBlock)(true), (0, vue.createElementBlock)(vue.Fragment, null, (0, vue.renderList)(segments.end, ({ part, value }) => {
						return (0, vue.openBlock)(), (0, vue.createElementBlock)(vue.Fragment, { key: `end-${part}` }, [part === "literal" ? ((0, vue.openBlock)(), (0, vue.createBlock)((0, vue.unref)(require_DateRangeFieldInput.DateRangeFieldInput_default), {
							key: 0,
							type: "end",
							part,
							class: "b-date-range-field-literal"
...
//#endregion
//#region src/components/BDateField/BTimeRangeField.vue
var BTimeRangeField_default = /* @__PURE__ */ (0, vue.defineComponent)({
	__name: "BTimeRangeField",
	props: /* @__PURE__ */ (0, vue.mergeModels)({
		defaultPlaceholder: { default: void 0 },
		defaultValue: { default: void 0 },
		dir: { default: void 0 },
	...
	emits: ["update:modelValue", "update:placeholder"],
	setup(__props) {
		const props = require_useDefaults.useDefaults(__props, "BTimeRangeField");
		const modelValue = (0, vue.useModel)(__props, "modelValue");
		const placeholderModel = (0, vue.useModel)(__props, "placeholder");
		const computedId = require_useId.useId(() => props.id, "time-range-field");
		const computedRootClasses = (0, vue.computed)(() => ({
			"disabled": props.disabled,
			"readonly": props.readonly,
			"is-valid": props.state === true,
		...
		return (_ctx, _cache) => {
			return (0, vue.openBlock)(), (0, vue.createBlock)((0, vue.unref)(TimeRangeFieldRoot_default), {
				id: (0, vue.unref)(computedId),
				modelValue: modelValue.value,
				"onUpdate:modelValue": _cache[0] || (_cache[0] = ($event) => modelValue.value = $event),
				placeholder: placeholderModel.value,
				...
				required: (0, vue.unref)(props).required,
				dir: (0, vue.unref)(props).dir,
				"is-time-unavailable": (0, vue.unref)(props).isTimeUnavailable,
				class: (0, vue.normalizeClass)([computedRootClasses.value, "b-time-range-field form-control d-inline-flex align-items-center gap-0"])
			}, {
				default: (0, vue.withCtx)(({ segments, isInvalid, modelValue: currentValue }) => [(0, vue.renderSlot)(_ctx.$slots, "default", {
					modelValue: currentValue,
					segments,
					...
					((0, vue.openBlock)(true), (0, vue.createElementBlock)(vue.Fragment, null, (0, vue.renderList)(segments.start, ({ part, value }) => {
						return (0, vue.openBlock)(), (0, vue.createElementBlock)(vue.Fragment, { key: `start-${part}` }, [part === "literal" ? ((0, vue.openBlock)(), (0, vue.createBlock)((0, vue.unref)(TimeRangeFieldInput_default), {
							key: 0,
							type: "start",
							part,
							...
							default: (0, vue.withCtx)(() => [(0, vue.createTextVNode)((0, vue.toDisplayString)(value), 1)]),
							_: 2
						}, 1032, ["part"])) : ((0, vue.openBlock)(), (0, vue.createBlock)((0, vue.unref)(TimeRangeFieldInput_default), {
							key: 1,
							type: "start",
							part,
							class: "b-time-range-field-segment"
						}, {
							default: (0, vue.withCtx)(() => [(0, vue.createTextVNode)((0, vue.toDisplayString)(value), 1)]),
							_: 2
						}, 1032, ["part"]))], 64);
					...
					_cache[2] || (_cache[2] = (0, vue.createElementVNode)("span", {
						class: "b-time-range-field-separator",
						"aria-hidden": "true"
					}, " – ", -1)),
					((0, vue.openBlock)(true), (0, vue.createElementBlock)(vue.Fragment, null, (0, vue.renderList)(segments.end, ({ part, value }) => {
						return (0, vue.openBlock)(), (0, vue.createElementBlock)(vue.Fragment, { key: `end-${part}` }, [part === "literal" ? ((0, vue.openBlock)(), (0, vue.createBlock)((0, vue.unref)(TimeRangeFieldInput_default), {
							key: 0,
							type: "end",
							part,
							class: "b-time-range-field-literal"
...
//#endregion
Object.defineProperty(exports, "BDateField_default", {
	enumerable: true,
	get: function() {
		return BDateField_default;
	}
});
Object.defineProperty(exports, "BDateRangeField_default", {
	enumerable: true,
	get: function() {
		return BDateRangeField_default;
	}
});
Object.defineProperty(exports, "BTimeRangeField_default", {
	enumerable: true,
	get: function() {
		return BTimeRangeField_default;
	}
});

//# sourceMappingURL=BDateField-DzZw5FRX.js.map