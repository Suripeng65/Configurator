import { a as buttonGroupKey } from "./keys-DU7sQgl3.mjs";
...
import "./BCloseButton-CKTKr4PS.mjs";
import "./BButton-PY7AANXJ.mjs";
...
var BButtonGroup_default = /* @__PURE__ */ defineComponent({
	__name: "BButtonGroup",
	props: {
...
var BButtonToolbar_default = /* @__PURE__ */ defineComponent({
	...
	setup(__props) {
		const props = useDefaults(__props, "BButtonToolbar");
		const toolbarRef = useTemplateRef("toolbarRef");
		const computedClasses = computed(() => ({ "justify-content-between": props.justify }));
...
//# sourceMappingURL=BButton-BSa7LfL5.mjs.map