import { c as collapseInjectionKey, g as navbarInjectionKey, u as dropdownInjectionKey } from "./keys-DU7sQgl3.mjs";
import { t as useDefaults } from "./useDefaults-DseelK6y.mjs";
import { r as useBLinkHelper, t as BLink_default } from "./BLink-Dfgte6dQ.mjs";
import { t as useColorVariantClasses } from "./useColorVariantClasses-CqeXHjRh.mjs";
import "./BDropdown-B1DbvVzm.mjs";
...
var BDropdownDivider_default = /* @__PURE__ */ defineComponent({
	inheritAttrs: false,
	...
	setup(__props) {
		const props = useDefaults(__props, "BDropdownDivider");
		...
		return (_ctx, _cache) => {
			...
			}, __props.wrapperAttrs), [(openBlock(), createBlock(resolveDynamicComponent(unref(props).tag), mergeProps({
...
var BDropdownForm_default = /* @__PURE__ */ defineComponent({
	inheritAttrs: false,
	...
	setup(__props) {
		const props = useDefaults(__props, "BDropdownForm");
		const attrs = useAttrs();
		const processedAttrs = computed(() => {
		...
		const computedClasses = computed(() => [props.formClass, { "was-validated": props.validated }]);
		return (_ctx, _cache) => {
			return openBlock(), createElementBlock("li", mergeProps({
				role: "presentation",
				class: processedAttrs.value.wrapperClass
			...
			}, processedAttrs.value.formAttrs), [renderSlot(_ctx.$slots, "default")], 16, _hoisted_1$2)], 16);
		};
	}
});
//#endregion
...
var BDropdownGroup_default = /* @__PURE__ */ defineComponent({
	inheritAttrs: false,
	...
	setup(__props) {
		const props = useDefaults(__props, "BDropdownGroup");
		...
		const colorClasses = useColorVariantClasses(computed(() => ({ textVariant: props.headerVariant })));
		...
		return (_ctx, _cache) => {
			return openBlock(), createElementBlock("li", _hoisted_1$1, [(openBlock(), createBlock(resolveDynamicComponent(unref(props).headerTag), {
				...
				role: "group",
				class: "list-unstyled"
			}, _ctx.$attrs, { "aria-describedby": unref(props).ariaDescribedby || headerId.value }), [renderSlot(_ctx.$slots, "default")], 16, _hoisted_2)]);
		};
	}
});
//#endregion
//#region src/components/BDropdown/BDropdownHeader.vue
var BDropdownHeader_default = /* @__PURE__ */ defineComponent({
	inheritAttrs: false,
	...
	setup(__props) {
		const props = useDefaults(__props, "BDropdownHeader");
		const attrs = useAttrs();
		const processedAttrs = computed(() => {
		...
		return (_ctx, _cache) => {
			return openBlock(), createElementBlock("li", mergeProps({
				role: "presentation",
				class: processedAttrs.value.wrapperClass
			}, __props.wrapperAttrs), [(openBlock(), createBlock(resolveDynamicComponent(unref(props).tag), mergeProps({ class: ["dropdown-header", [unref(colorClasses), unref(props).headerClass]] }, processedAttrs.value.headerAttrs), {
...
var BDropdownItem_default = /* @__PURE__ */ defineComponent({
	inheritAttrs: false,
	...
	setup(__props, { emit: __emit }) {
		const props = useDefaults(__props, "BDropdownItem");
		const emit = __emit;
		const attrs = useAttrs();
		const processedAttrs = computed(() => {
		...
		const computedTag = computed(() => computedLink.value ? BLink_default : props.href ? "a" : "button");
...
var BDropdownItemButton_default = /* @__PURE__ */ defineComponent({
	inheritAttrs: false,
	...
	emits: ["click"],
	setup(__props, { emit: __emit }) {
		const props = useDefaults(__props, "BDropdownItemButton");
		const emit = __emit;
		const attrs = useAttrs();
		const processedAttrs = computed(() => {
		...
		return (_ctx, _cache) => {
			return openBlock(), createElementBlock("li", mergeProps({
				...
				class: ["dropdown-item", computedClasses.value],
				disabled: unref(props).disabled
			}, processedAttrs.value.buttonAttrs, { onClick: clicked }), [renderSlot(_ctx.$slots, "default")], 16, _hoisted_1)], 16);
		};
	}
});
//#endregion
//#region src/components/BDropdown/BDropdownText.vue
var BDropdownText_default = /* @__PURE__ */ defineComponent({
	inheritAttrs: false,
	...
	setup(__props) {
		const props = useDefaults(__props, "BDropdownText");
		const attrs = useAttrs();
		const processedAttrs = computed(() => {
		...
		return (_ctx, _cache) => {
			return openBlock(), createElementBlock("li", mergeProps({
				role: "presentation",
				class: processedAttrs.value.wrapperClass
			}, __props.wrapperAttrs), [(openBlock(), createBlock(resolveDynamicComponent(unref(props).tag), mergeProps({ class: ["dropdown-item-text", [unref(colorClasses), unref(props).textClass]] }, processedAttrs.value.textAttrs), {
				default: withCtx(() => [renderSlot(_ctx.$slots, "default", {}, () => [createTextVNode(toDisplayString(unref(props).text), 1)])]),
				_: 3
			}, 16, ["class"]))], 16);
		};
...
//# sourceMappingURL=BDropdown-0E8x5kk6.mjs.map