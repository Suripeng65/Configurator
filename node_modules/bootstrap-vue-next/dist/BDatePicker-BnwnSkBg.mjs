import { A as reactiveOmit, S as useVModel, f as useEventListener } from "./dist-Dk9C_HFS.mjs";
import { t as useDefaults } from "./useDefaults-DseelK6y.mjs";
import { t as useId$1 } from "./useId-D1sqXtwx.mjs";
...
import { t as useForwardExpose } from "./useForwardExpose-Cob6LlGd.mjs";
...
import { i as DateFieldRoot_default, n as DateRangeFieldRoot_default, r as DateFieldInput_default, t as DateRangeFieldInput_default } from "./DateRangeFieldInput-B86VEz0H.mjs";
...
var DatePickerContent_default = /* @__PURE__ */ defineComponent({
...
var DatePickerField_default = /* @__PURE__ */ defineComponent({
...
var DatePickerGrid_default = /* @__PURE__ */ defineComponent({
...
var DatePickerGridBody_default = /* @__PURE__ */ defineComponent({
...
var DatePickerGridHead_default = /* @__PURE__ */ defineComponent({
...
var DatePickerGridRow_default = /* @__PURE__ */ defineComponent({
...
var DatePickerHeadCell_default = /* @__PURE__ */ defineComponent({
...
var DatePickerHeader_default = /* @__PURE__ */ defineComponent({
...
var DatePickerHeading_default = /* @__PURE__ */ defineComponent({
...
var DatePickerInput_default = /* @__PURE__ */ defineComponent({
...
var DatePickerNext_default = /* @__PURE__ */ defineComponent({
...
var DatePickerPrev_default = /* @__PURE__ */ defineComponent({
...
var DatePickerTrigger_default = /* @__PURE__ */ defineComponent({
...
var RangeCalendarRoot_default = /* @__PURE__ */ defineComponent({
	...
	setup(__props, { emit: __emit }) {
		...
		watch(modelValue, (_modelValue) => {
			...
			if (!(!next.start && !startValue.value || !!next.start && !!startValue.value && $14e0f24ef4ac5c92$export$91b62ebf2ba703ee(next.start, startValue.value))) startValue.value = next.start?.copy?.();
			if (!(!next.end && !endValue.value || !!next.end && !!endValue.value && $14e0f24ef4ac5c92$export$91b62ebf2ba703ee(next.end, endValue.value))) endValue.value = next.end?.copy?.();
		});
		...
		return (_ctx, _cache) => {
			return openBlock(), createBlock(unref(Primitive), {
				...
				default: withCtx(() => [createElementVNode("div", _hoisted_1$2, [createElementVNode("div", _hoisted_2, toDisplayString(unref(fullCalendarLabel)), 1)]), renderSlot(_ctx.$slots, "default", {
					date: unref(placeholder),
					grid: unref(grid),
					weekDays: unref(weekdays),
					weekStartsOn: weekStartsOn.value,
...
var RangeCalendarCellTrigger_default = /* @__PURE__ */ defineComponent({
	...
	setup(__props) {
		...
		const isFocusedDate = computed(() => {
			if (isOutsideView.value || isDisabled.value) return false;
			if (!rootContext.disabled.value && rootContext.isPlaceholderFocusable.value && $14e0f24ef4ac5c92$export$ea39ec197993aef0(props.day, rootContext.placeholder.value)) return true;
			if (!rootContext.disabled.value && rootContext.selectedFocusableDate.value && !rootContext.isPlaceholderFocusable.value) return $14e0f24ef4ac5c92$export$ea39ec197993aef0(props.day, rootContext.selectedFocusableDate.value);
			if (!rootContext.disabled.value && (!rootContext.hasSelectedDate.value || rootContext.isSelectedDisabled.value) && !rootContext.isPlaceholderFocusable.value) return rootContext.firstFocusableDate.value && $14e0f24ef4ac5c92$export$ea39ec197993aef0(props.day, rootContext.firstFocusableDate.value);
			return false;
		});
...
var DateRangePickerField_default = /* @__PURE__ */ defineComponent({
...
var BDatePicker_default = /* @__PURE__ */ defineComponent({
	__name: "BDatePicker",
	...
	setup(__props) {
		...
		return (_ctx, _cache) => {
			return openBlock(), createBlock(unref(DatePickerRoot_default), {
				id: unref(computedId),
				...
				"default-placeholder": unref(props).defaultPlaceholder,
				"hour-cycle": unref(props).hourCycle,
				step: unref(props).step,
				granularity: unref(props).granularity,
				"hide-time-zone": unref(props).hideTimeZone,
				"max-value": unref(props).maxValue,
				"min-value": unref(props).minValue,
				locale: unref(props).locale,
				disabled: unref(props).disabled,
				readonly: unref(props).readonly,
				name: unref(props).name,
				required: unref(props).required,
				dir: unref(props).dir,
				"is-date-unavailable": unref(props).isDateUnavailable,
				"is-date-disabled": unref(props).isDateDisabled,
				"close-on-select": unref(props).closeOnSelect,
				"default-open": unref(props).defaultOpen,
				modal: unref(props).modal,
				"number-of-months": unref(props).numberOfMonths,
				"paged-navigation": unref(props).pagedNavigation,
				"week-starts-on": unref(props).weekStartsOn,
				"weekday-format": unref(props).weekdayFormat,
				"fixed-weeks": unref(props).fixedWeeks,
				"prevent-deselect": unref(props).preventDeselect
			}, {
				default: withCtx(() => [createVNode(unref(DatePickerField_default), { class: normalizeClass(["b-date-picker-field form-control d-inline-flex align-items-center gap-0", computedFieldClasses.value]) }, {
					default: withCtx(({ segments }) => [renderSlot(_ctx.$slots, "field", { segments }, () => [(openBlock(true), createElementBlock(Fragment, null, renderList(segments, ({ part, value }) => {
						return openBlock(), createElementBlock(Fragment, { key: part }, [part === "literal" ? (openBlock(), createBlock(unref(DatePickerInput_default), {
							key: 0,
							part,
							class: "b-date-picker-literal"
						}, {
							default: withCtx(() => [createTextVNode(toDisplayString(value), 1)]),
							_: 2
						}, 1032, ["part"])) : (openBlock(), createBlock(unref(DatePickerInput_default), {
							key: 1,
							part,
					...
					}), 128))]), createVNode(unref(DatePickerTrigger_default), {
						class: normalizeClass(["btn btn-outline-secondary b-date-picker-trigger ms-auto", [unref(props).size ? `btn-${unref(props).size}` : ""]]),
						disabled: unref(props).disabled
					}, {
						default: withCtx(() => [renderSlot(_ctx.$slots, "trigger-icon", {}, () => [_cache[3] || (_cache[3] = createElementVNode("svg", {
							xmlns: "http://www.w3.org/2000/svg",
							width: "16",
							height: "16",
							fill: "currentColor",
							viewBox: "0 0 16 16"
						}, [createElementVNode("path", { d: "M3.5 0a.5.5 0 0 1 .5.5V1h8V.5a.5.5 0 0 1 1 0V1h1a2 2 0 0 1 2 2v11a2 2 0 0 1-2 2H2a2 2 0 0 1-2-2V3a2 2 0 0 1 2-2h1V.5a.5.5 0 0 1 .5-.5M1 4v10a1 1 0 0 0 1 1h12a1 1 0 0 0 1-1V4z" })], -1))])]),
						_: 3
					}, 8, ["class", "disabled"])]),
					_: 3
				}, 8, ["class"]), createVNode(unref(DatePickerContent_default), {
					"side-offset": 4,
					class: "b-date-picker-content dropdown-menu show p-2"
				}, {
					default: withCtx(() => [createVNode(unref(DatePickerCalendar_default), null, {
						default: withCtx(({ weekDays, grid }) => [renderSlot(_ctx.$slots, "calendar", {
							weekDays,
							grid
						}, () => [createVNode(unref(DatePickerHeader_default), { class: "d-flex align-items-center justify-content-between mb-2" }, {
							default: withCtx(() => [
								createVNode(unref(DatePickerPrev_default), { class: "btn btn-sm btn-outline-secondary" }, {
									default: withCtx(() => [renderSlot(_ctx.$slots, "prev-icon", {}, () => [_cache[4] || (_cache[4] = createElementVNode("svg", {
										xmlns: "http://www.w3.org/2000/svg",
										width: "16",
										height: "16",
										fill: "currentColor",
								...
								createVNode(unref(DatePickerHeading_default), { class: "fw-semibold" }),
								createVNode(unref(DatePickerNext_default), { class: "btn btn-sm btn-outline-secondary" }, {
									default: withCtx(() => [renderSlot(_ctx.$slots, "next-icon", {}, () => [_cache[5] || (_cache[5] = createElementVNode("svg", {
										xmlns: "http://www.w3.org/2000/svg",
										width: "16",
										height: "16",
										fill: "currentColor",
							...
							_: 3
						}), createElementVNode("div", _hoisted_1$1, [(openBlock(true), createElementBlock(Fragment, null, renderList(grid, (month) => {
							return openBlock(), createBlock(unref(DatePickerGrid_default), { key: month.value.toString() }, {
								default: withCtx(() => [createVNode(unref(DatePickerGridHead_default), null, {
									default: withCtx(() => [createVNode(unref(DatePickerGridRow_default), { class: "b-date-picker-weekdays" }, {
										default: withCtx(() => [(openBlock(true), createElementBlock(Fragment, null, renderList(weekDays, (day) => {
											return openBlock(), createBlock(unref(DatePickerHeadCell_default), {
												key: day,
									...
									_: 2
								}, 1024), createVNode(unref(DatePickerGridBody_default), null, {
									default: withCtx(() => [(openBlock(true), createElementBlock(Fragment, null, renderList(month.rows, (weekDates, index) => {
										return openBlock(), createBlock(unref(DatePickerGridRow_default), { key: `weekDate-${index}` }, {
											default: withCtx(() => [(openBlock(true), createElementBlock(Fragment, null, renderList(weekDates, (weekDate) => {
												return openBlock(), createBlock(unref(DatePickerCell_default), {
													key: weekDate.toString(),
													date: weekDate,
													class: "b-date-picker-cell"
												}, {
													default: withCtx(() => [createVNode(unref(DatePickerCellTrigger_default), {
														day: weekDate,
														month: month.value,
...
var BDateRangePicker_default = /* @__PURE__ */ defineComponent({
	...
	emits: /* @__PURE__ */ mergeModels(["update:placeholder", "update:startValue"], [
		"update:modelValue",
		"update:open",
		"update:placeholder"
	]),
	setup(__props, { emit: __emit }) {
		const props = useDefaults(__props, "BDateRangePicker");
		const emit = __emit;
		const modelValue = useModel(__props, "modelValue");
		const openModel = useModel(__props, "open");
		const placeholderModel = useModel(__props, "placeholder");
		const computedId = useId$1(() => props.id, "date-range-picker");
		const computedFieldClasses = computed(() => ({
			"disabled": props.disabled,
			"readonly": props.readonly,
			"is-valid": props.state === true,
		...
		return (_ctx, _cache) => {
			return openBlock(), createBlock(unref(DateRangePickerRoot_default), {
				id: unref(computedId),
				modelValue: modelValue.value,
				"onUpdate:modelValue": _cache[0] || (_cache[0] = ($event) => modelValue.value = $event),
				open: openModel.value,
				...
				"fixed-weeks": unref(props).fixedWeeks,
				"prevent-deselect": unref(props).preventDeselect,
				"allow-non-contiguous-ranges": unref(props).allowNonContiguousRanges,
				"fixed-date": unref(props).fixedDate,
				"maximum-days": unref(props).maximumDays,
				"is-date-highlightable": unref(props).isDateHighlightable,
				"onUpdate:startValue": _cache[3] || (_cache[3] = (val) => emit("update:startValue", val))
			}, {
				default: withCtx(() => [createVNode(unref(DateRangePickerField_default), { class: normalizeClass(["b-date-range-picker-field form-control d-inline-flex align-items-center gap-0", computedFieldClasses.value]) }, {
					default: withCtx(({ segments }) => [renderSlot(_ctx.$slots, "field", { segments }, () => [
						(openBlock(true), createElementBlock(Fragment, null, renderList(segments.start, ({ part, value }) => {
							return openBlock(), createElementBlock(Fragment, { key: `start-${part}` }, [part === "literal" ? (openBlock(), createBlock(unref(DateRangePickerInput_default), {
								key: 0,
								type: "start",
								part,
						...
						(openBlock(true), createElementBlock(Fragment, null, renderList(segments.end, ({ part, value }) => {
							return openBlock(), createElementBlock(Fragment, { key: `end-${part}` }, [part === "literal" ? (openBlock(), createBlock(unref(DateRangePickerInput_default), {
								key: 0,
								type: "end",
								part,
								class: "b-date-range-picker-literal"
					...
					]), createVNode(unref(DateRangePickerTrigger_default), {
						class: normalizeClass(["btn btn-outline-secondary b-date-range-picker-trigger ms-auto", [unref(props).size ? `btn-${unref(props).size}` : ""]]),
						disabled: unref(props).disabled
					}, {
						default: withCtx(() => [renderSlot(_ctx.$slots, "trigger-icon", {}, () => [_cache[5] || (_cache[5] = createElementVNode("svg", {
							xmlns: "http://www.w3.org/2000/svg",
							width: "16",
							height: "16",
							fill: "currentColor",
					...
					_: 3
				}, 8, ["class"]), createVNode(unref(DateRangePickerContent_default), {
					"side-offset": 4,
					class: "b-date-range-picker-content dropdown-menu show p-2"
				}, {
					default: withCtx(() => [createVNode(unref(DateRangePickerCalendar_default), null, {
						default: withCtx(({ weekDays, grid }) => [renderSlot(_ctx.$slots, "calendar", {
							weekDays,
							grid
						}, () => [createVNode(unref(DateRangePickerHeader_default), { class: "d-flex align-items-center justify-content-between mb-2" }, {
							default: withCtx(() => [
								createVNode(unref(DateRangePickerPrev_default), { class: "btn btn-sm btn-outline-secondary" }, {
									default: withCtx(() => [renderSlot(_ctx.$slots, "prev-icon", {}, () => [_cache[6] || (_cache[6] = createElementVNode("svg", {
										xmlns: "http://www.w3.org/2000/svg",
										width: "16",
										height: "16",
										fill: "currentColor",
								...
								createVNode(unref(DateRangePickerHeading_default), { class: "fw-semibold" }),
								createVNode(unref(DateRangePickerNext_default), { class: "btn btn-sm btn-outline-secondary" }, {
									default: withCtx(() => [renderSlot(_ctx.$slots, "next-icon", {}, () => [_cache[7] || (_cache[7] = createElementVNode("svg", {
										xmlns: "http://www.w3.org/2000/svg",
										width: "16",
										height: "16",
										fill: "currentColor",
							...
							_: 3
						}), createElementVNode("div", _hoisted_1, [(openBlock(true), createElementBlock(Fragment, null, renderList(grid, (month) => {
							return openBlock(), createBlock(unref(DateRangePickerGrid_default), { key: month.value.toString() }, {
								default: withCtx(() => [createVNode(unref(DateRangePickerGridHead_default), null, {
									default: withCtx(() => [createVNode(unref(DateRangePickerGridRow_default), { class: "b-date-range-picker-weekdays" }, {
										default: withCtx(() => [(openBlock(true), createElementBlock(Fragment, null, renderList(weekDays, (day) => {
									...
									default: withCtx(() => [(openBlock(true), createElementBlock(Fragment, null, renderList(month.rows, (weekDates, index) => {
										return openBlock(), createBlock(unref(DateRangePickerGridRow_default), { key: `weekDate-${index}` }, {
											default: withCtx(() => [(openBlock(true), createElementBlock(Fragment, null, renderList(weekDates, (weekDate) => {
...
//#endregion
export { BDatePicker_default as n, BDateRangePicker_default as t };

//# sourceMappingURL=BDatePicker-BnwnSkBg.mjs.map