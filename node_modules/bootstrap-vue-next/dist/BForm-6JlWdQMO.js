		...
		return (_ctx, _cache) => {
			return (0, vue.openBlock)(), (0, vue.createElementBlock)("datalist", { id: (0, vue.unref)(computedId) }, [
				...
				((0, vue.openBlock)(true), (0, vue.createElementBlock)(vue.Fragment, null, (0, vue.renderList)(normalizedOptsWrapper.value, (option, index) => {
					return (0, vue.openBlock)(), (0, vue.createBlock)(require_BFormSelectOption.BFormSelectOption_default, (0, vue.mergeProps)({ key: index }, { ref_for: true }, option), {
...
var BFormFloatingLabel_default = /* @__PURE__ */ (0, vue.defineComponent)({
	...
	setup(__props) {
		...
		const parentFormGroupData = (0, vue.inject)(require_keys.formGroupKey, null)?.();
		if (parentFormGroupData) require_BFormValidFeedback.useProvideFormGroupData(parentFormGroupData);
		return (_ctx, _cache) => {
...
//# sourceMappingURL=BForm-6JlWdQMO.js.map