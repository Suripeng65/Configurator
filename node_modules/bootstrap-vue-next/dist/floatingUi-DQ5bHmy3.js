...
var BPopover_default = /* @__PURE__ */ (0, vue.defineComponent)({
	...
	setup(__props, { expose: __expose, emit: __emit }) {
		...
		const floatingMiddleware = (0, vue.computed)(() => {
			...
			if (!props.noFlip && !isAutoPlacement.value) arr.push(require_floating_ui_vue.flip({
			...
			if (!props.noHide) arr.push(require_floating_ui_vue.hide({
				boundary: boundary.value,
				rootBoundary: rootBoundary.value,
				padding: props.boundaryPadding
			}));
			if (props.inline) arr.push(require_floating_ui_vue.inline());
...
//# sourceMappingURL=floatingUi-DQ5bHmy3.js.map