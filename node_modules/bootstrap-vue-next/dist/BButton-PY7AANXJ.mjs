import { a as onKeyStroke } from "./dist-Dk9C_HFS.mjs";
import { t as useDefaults } from "./useDefaults-DseelK6y.mjs";
import { n as useLinkClasses, r as useBLinkHelper, t as BLink_default } from "./BLink-Dfgte6dQ.mjs";
import { t as BSpinner_default } from "./BSpinner-CUfGqviV.mjs";
import { Fragment, computed, createBlock, createCommentVNode, createElementBlock, createTextVNode, createVNode, defineComponent, mergeModels, mergeProps, openBlock, renderSlot, resolveDynamicComponent, toDisplayString, unref, useModel, useTemplateRef, withCtx } from "vue";
//#endregion
...
var BButton_default = /* @__PURE__ */ defineComponent({
	...
	setup(__props, { emit: __emit }) {
		...
		const linkValueClasses = useLinkClasses(computed(() => ({ ...variantIsLinkType.value ? {
			icon: props.icon,
...
//# sourceMappingURL=BButton-PY7AANXJ.mjs.map