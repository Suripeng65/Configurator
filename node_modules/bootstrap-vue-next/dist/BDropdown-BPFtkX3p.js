...
const require_floating_ui_vue = require("./floating-ui.vue-DDOIU2nS.js");
	...
	setup(__props, { expose: __expose, emit: __emit }) {
		...
		const { update, floatingStyles } = require_floating_ui_vue.useFloating(referenceElement, floatingElement, {
			...
			middleware: (0, vue.computed)(() => {
				...
				if (!props.noFlip) arr.push(require_floating_ui_vue.flip({
					boundary: boundary.value,
					rootBoundary: rootBoundary.value,
					padding: props.boundaryPadding
				}));
				if (!props.noShift) arr.push(require_floating_ui_vue.shift({
					boundary: boundary.value,
					rootBoundary: rootBoundary.value,
					padding: props.boundaryPadding
				}));
				if (!props.noSize) arr.push(require_floating_ui_vue.size({
					boundary: boundary.value,
					rootBoundary: rootBoundary.value,
					padding: props.boundaryPadding,
...
//# sourceMappingURL=BDropdown-BPFtkX3p.js.map