import { l as defaultsKey } from "./keys-DU7sQgl3.mjs";
import { c as unbind, i as resolveActiveStatus, l as updateBind, o as resolveContent, s as resolveDirectiveProps, t as bind } from "./floatingUi-62aeQtAb.mjs";
...
function createFloatingDirective(propertyName, componentDefaultsKey, buildProps) {
	return {
		mounted(el, binding, vnode) {
			...
			if (!resolveActiveStatus(binding.value)) return;
			const text = resolveContent(binding.value, el);
			if (!text.body && !text.title) return;
			initDirectiveInstance(el, propertyName, uid, binding);
			bind(el, binding, buildProps ? buildProps(text, defaultsMap?.[componentDefaultsKey], binding, el) : {
		...
		updated(el, binding, vnode) {
			...
			const defaultsMap = findProvides(binding, vnode)[defaultsKey]?.value;
			if (!resolveActiveStatus(binding.value)) {
			...
			updateBind(el, binding, buildProps ? buildProps(text, defaultsMap?.[componentDefaultsKey], binding, el) : {
				...defaultsMap?.[componentDefaultsKey] || void 0,
				...resolveDirectiveProps(binding, el),
				...text
			});
...
//# sourceMappingURL=utils-CWvndqPg.mjs.map