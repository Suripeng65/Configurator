...
var BRow_default = /* @__PURE__ */ defineComponent({
	__name: "BRow",
	props: {
		tag: { default: "div" },
	...
	setup(__props) {
		const props = useDefaults(__props, "BRow");
		const alignment = useAlignment(() => props.alignH);
		const rowColsClasses = computed(() => getClasses({
			cols: props.cols,
			colsLg: props.colsLg,
			colsMd: props.colsMd,
			colsSm: props.colsSm,
		...
		const computedClasses = computed(() => [rowColsClasses.value, {
		...
		return (_ctx, _cache) => {
			return openBlock(), createBlock(resolveDynamicComponent(unref(props).tag), { class: normalizeClass(["row", computedClasses.value]) }, {
...
//#endregion
export { BRow_default as t };

//# sourceMappingURL=BRow-eGSUYGCW.mjs.map