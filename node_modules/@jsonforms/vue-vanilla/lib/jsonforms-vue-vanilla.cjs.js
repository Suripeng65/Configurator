...
function render$l(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  }, " ↑ ", 10, _hoisted_1$i), vue.createElementVNode("button", {
  ...
  }, " ↓ ", 10, _hoisted_2$7), vue.createElementVNode("button", {
  ...
  }, " 🗙 ", 10, _hoisted_3$2)], 2), vue.createElementVNode("div", {
...
var controlRenderer$d = vue.defineComponent({
  ...
  computed: {
    ...
    translations: function translations() {
      ...
      var jsonforms = vue$1.useJsonForms();
      return core.getArrayTranslations((_jsonforms$i18n$trans = jsonforms === null || jsonforms === void 0 || (_jsonforms$i18n = jsonforms.i18n) === null || _jsonforms$i18n === void 0 ? void 0 : _jsonforms$i18n.translate) !== null && _jsonforms$i18n$trans !== void 0 ? _jsonforms$i18n$trans : core.defaultJsonFormsI18nState.translate, core.arrayDefaultTranslations, this.control.i18nKeyPrefix, this.control.label);
    }
  },
  methods: {
...
function render$k(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  }, " + ", 10, _hoisted_1$h), vue.createElementVNode("label", {
  ...
  }, vue.toDisplayString(_ctx.translations.noDataMessage), 3)) : vue.createCommentVNode("", true)], 2)) : vue.createCommentVNode("", true);
}
...
function render$j(_ctx, _cache, $props, $setup, $data, $options) {
  return _ctx.visible ? (vue.openBlock(), vue.createElementBlock("div", {
    ...
    "for": _ctx.id + '-input',
    "class": vue.normalizeClass([_ctx.styles.control.label, _ctx.required ? _ctx.styles.control.required : ''])
  }, [vue.createTextVNode(vue.toDisplayString(_ctx.label) + " ", 1), _ctx.showAsterisk ? (vue.openBlock(), vue.createElementBlock("span", {
    key: 0,
    "class": vue.normalizeClass(_ctx.styles.control.asterisk)
  }, "*", 2)) : vue.createCommentVNode("", true)], 10, _hoisted_2$6), vue.createElementVNode("div", {
  ...
  }, vue.toDisplayString(_ctx.errors ? _ctx.errors : _ctx.showDescription ? _ctx.description : null), 3)], 10, _hoisted_1$g)) : vue.createCommentVNode("", true);
}
...
var layoutRenderer$1 = vue.defineComponent({
  ...
  props: _objectSpread2({}, vue$1.rendererProps()),
  setup: function setup(props) {
    return useVanillaLayout(vue$1.useJsonFormsCategorization(props));
  },
  data: function data() {
    return {
      selected: 0
...
var entry$5 = {
  ...
  tester: core.rankWith(2, core.and(core.isCategorization, core.categorizationHasCategory))
};

var _hoisted_1$5 = ["onClick"];
var _hoisted_2$3 = ["disabled"];
function render$6(_ctx, _cache, $props, $setup, $data, $options) {
  var _component_DispatchRenderer = vue.resolveComponent("DispatchRenderer");
  return vue.openBlock(), vue.createElementBlock("div", {
    "class": vue.normalizeClass(_ctx.styles.categorization.root)
  }, [vue.createElementVNode("div", {
    "class": vue.normalizeClass(_ctx.styles.categorization.category)
  }, [(vue.openBlock(true), vue.createElementBlock(vue.Fragment, null, vue.renderList(_ctx.categories, function (category, index) {
    return vue.openBlock(), vue.createElementBlock(vue.Fragment, {
      key: "category-".concat(index)
    }, [category.value.visible ? (vue.openBlock(), vue.createElementBlock("div", {
      key: 0,
      onClick: function onClick($event) {
        return _ctx.selected = index;
      }
    }, [vue.createElementVNode("button", {
      "class": vue.normalizeClass([_ctx.selected === index ? _ctx.styles.categorization.selected : '']),
      disabled: !category.value.enabled
    }, [vue.createElementVNode("label", null, vue.toDisplayString(category.value.label), 1)], 10, _hoisted_2$3)], 8, _hoisted_1$5)) : vue.createCommentVNode("", true)], 64);
  }), 128))], 2), vue.createElementVNode("div", {
    "class": vue.normalizeClass(_ctx.styles.categorization.panel)
  }, [_ctx.categories[_ctx.selected] ? (vue.openBlock(), vue.createBlock(_component_DispatchRenderer, {
    key: 0,
    schema: _ctx.layout.schema,
    ...
    renderers: _ctx.layout.renderers,
    cells: _ctx.layout.cells
  }, null, 8, ["schema", "uischema", "path", "enabled", "renderers", "cells"])) : vue.createCommentVNode("", true)], 2)], 2);
}
...
var entry$4 = {
  ...
  tester: core.rankWith(3, core.and(core.isCategorization, core.categorizationHasCategory, core.optionIs('variant', 'stepper')))
};
...
function render$5(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return vue.openBlock(), vue.createElementBlock("div", {
    ...
    "class": vue.normalizeClass(_ctx.styles.categorization.stepper)
  }, [(vue.openBlock(true), vue.createElementBlock(vue.Fragment, null, vue.renderList(_ctx.visibleCategories, function (category, index) {
    return vue.openBlock(), vue.createElementBlock(vue.Fragment, {
      ...
      "class": vue.normalizeClass(_ctx.styles.categorization.stepperBadge)
    }, vue.toDisplayString(index + 1), 3), vue.createElementVNode("label", null, vue.toDisplayString(category.value.label), 1)], 10, _hoisted_2$2)], 8, _hoisted_1$4)) : vue.createCommentVNode("", true), index !== _ctx.visibleCategories.length - 1 ? (vue.openBlock(), vue.createElementBlock("hr", {
      key: 1,
      "class": vue.normalizeClass(_ctx.styles.categorization.stepperLine)
    }, null, 2)) : vue.createCommentVNode("", true)], 64);
  }), 128))], 2), vue.createElementVNode("div", {
    "class": vue.normalizeClass(_ctx.styles.categorization.panel)
  }, [_ctx.visibleCategories[_ctx.selected] ? (vue.openBlock(), vue.createBlock(_component_DispatchRenderer, {
    key: 0,
    schema: _ctx.layout.schema,
    ...
    renderers: _ctx.layout.renderers,
    cells: _ctx.layout.cells
  }, null, 8, ["schema", "uischema", "path", "enabled", "renderers", "cells"])) : vue.createCommentVNode("", true)], 2), (_ctx$appliedOptions = _ctx.appliedOptions) !== null && _ctx$appliedOptions !== void 0 && _ctx$appliedOptions.showNavButtons ? (vue.openBlock(), vue.createElementBlock("footer", {
    key: 0,
    "class": vue.normalizeClass(_ctx.styles.categorization.stepperFooter)
  }, [_ctx.selected > 0 ? (vue.openBlock(), vue.createElementBlock("div", {
    key: 0,
    "class": vue.normalizeClass(_ctx.styles.categorization.stepperButtonBack),
    onClick: _cache[0] || (_cache[0] = function ($event) {
      return _ctx.selected = _ctx.selected - 1;
    })
  }, [vue.createElementVNode("button", {
    disabled: !_ctx.visibleCategories[_ctx.selected - 1].value.enabled
  }, vue.toDisplayString('back'), 8, _hoisted_3$1)], 2)) : vue.createCommentVNode("", true), _ctx.selected + 1 < _ctx.visibleCategories.length ? (vue.openBlock(), vue.createElementBlock("div", {
    key: 1,
    "class": vue.normalizeClass(_ctx.styles.categorization.stepperButtonNext),
    onClick: _cache[1] || (_cache[1] = function ($event) {
      return _ctx.selected = _ctx.selected + 1;
    })
  }, [vue.createElementVNode("button", {
    disabled: !_ctx.visibleCategories[_ctx.selected + 1].value.enabled
  }, vue.toDisplayString('next'), 8, _hoisted_4$1)], 2)) : vue.createCommentVNode("", true)], 2)) : vue.createCommentVNode("", true)], 2);
}
...
function render$3(_ctx, _cache, $props, $setup, $data, $options) {
  var _component_dispatch_renderer = vue.resolveComponent("dispatch-renderer");
  return _ctx.isLayoutWithElements ? (vue.openBlock(), vue.createElementBlock("div", _hoisted_1$2, [vue.createVNode(_component_dispatch_renderer, {
...
var controlRenderer$1 = vue.defineComponent({
  ...
  computed: {
    ...
    translations: function translations() {
      var _jsonforms$i18n$trans, _jsonforms$i18n;
      var jsonforms = vue$1.useJsonForms();
      return core.getCombinatorTranslations((_jsonforms$i18n$trans = jsonforms === null || jsonforms === void 0 || (_jsonforms$i18n = jsonforms.i18n) === null || _jsonforms$i18n === void 0 ? void 0 : _jsonforms$i18n.translate) !== null && _jsonforms$i18n$trans !== void 0 ? _jsonforms$i18n$trans : core.defaultJsonFormsI18nState.translate, core.combinatorDefaultTranslations, this.control.i18nKeyPrefix, this.control.label);
    }
  },
  methods: {
...
function render$2(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  var _component_control_wrapper = vue.resolveComponent("control-wrapper");
  var _component_dispatch_renderer = vue.resolveComponent("dispatch-renderer");
  return _ctx.control.visible ? (vue.openBlock(), vue.createElementBlock("div", {
    key: 0,
    "class": vue.normalizeClass(_ctx.styles.oneOf.root)
  }, [vue.createVNode(_component_combinator_properties, {
    schema: _ctx.control.schema,
    "combinator-keyword": "oneOf",
    path: _ctx.path,
    "root-schema": _ctx.control.rootSchema
  }, null, 8, ["schema", "path", "root-schema"]), vue.createVNode(_component_control_wrapper, vue.mergeProps(_ctx.controlWrapper, {
    styles: _ctx.styles,
    "is-focused": _ctx.isFocused,
    "applied-options": _ctx.appliedOptions
  }), {
  ...
  }, vue.toDisplayString(_ctx.translations.clearDialogTitle), 3), vue.createElementVNode("p", {
    "class": vue.normalizeClass(_ctx.styles.dialog.body)
  }, vue.toDisplayString(_ctx.translations.clearDialogMessage), 3), vue.createElementVNode("div", {
    "class": vue.normalizeClass(_ctx.styles.dialog.actions)
  }, [vue.createElementVNode("button", {
    onclick: _ctx.onCancel,
    "class": vue.normalizeClass(_ctx.styles.dialog.buttonSecondary)
  }, vue.toDisplayString(_ctx.translations.clearDialogDecline), 11, _hoisted_3), vue.createElementVNode("button", {
    ref: "confirm",
    onclick: _ctx.onConfirm,
    "class": vue.normalizeClass(_ctx.styles.dialog.buttonPrimary)
  }, vue.toDisplayString(_ctx.translations.clearDialogAccept), 11, _hoisted_4)], 2)], 2)], 2)) : vue.createCommentVNode("", true);
}
...
var controlRenderer = vue.defineComponent({
  ...
  props: _objectSpread2({}, vue$1.rendererProps()),
  setup: function setup(props) {
    var control = vue$1.useJsonFormsMultiEnumControl(props);
...
function render$1(_ctx, _cache, $props, $setup, $data, $options) {
  return vue.openBlock(true), vue.createElementBlock(vue.Fragment, null, vue.renderList(_ctx.control.options, function (checkElement, index) {
    var _ctx$appliedOptions;
    return vue.openBlock(), vue.createElementBlock("div", {
      key: index
    ...
    }, null, 42, _hoisted_1), vue.createElementVNode("label", {
      "for": _ctx.control.id + "-input-".concat(index)
    }, vue.toDisplayString(checkElement.label), 9, _hoisted_2)]);
  }), 128);
}
...
exports.ArrayListRenderer = controlRenderer$d;
exports.BooleanControlRenderer = controlRenderer$3;
exports.CategorizationRenderer = layoutRenderer$1;
exports.CategorizationStepperRenderer = layoutRenderer;
exports.ControlWrapper = script$1;
exports.DateControlRenderer = controlRenderer$6;
exports.DateTimeControlRenderer = controlRenderer$5;
exports.EnumControlRenderer = controlRenderer$8;
exports.GroupRenderer = layoutRenderer$2;
exports.IntegerControlRenderer = controlRenderer$9;
exports.LabelRenderer = labelRenderer;
exports.LayoutRenderer = layoutRenderer$3;
exports.MultiStringControlRenderer = controlRenderer$b;
exports.NumberControlRenderer = controlRenderer$a;
exports.StringControlRenderer = controlRenderer$c;
exports.TimeControlRenderer = controlRenderer$4;
...
exports.oneOfEnumControlRenderer = controlRenderer$7;
