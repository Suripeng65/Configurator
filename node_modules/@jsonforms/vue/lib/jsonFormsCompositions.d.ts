 ...
 */
export declare function useJsonForms(): JsonFormsSubStates;
export declare function useJsonForms(optional: true): JsonFormsSubStates | undefined;
/**
 * Provides access to the JsonForms dispatch function.
 *
 * @returns The JsonForms dispatch function.
 */
export declare function useDispatch(): Dispatch<CoreActions>;
export declare function useDispatch(optional: true): Dispatch<CoreActions> | undefined;
/**
 * Provides access to the JsonForms translator function.
 * @returns The JsonForms translator function.
 */
export declare function useTranslator(): ComputedRef<Translator>;
export declare function useTranslator(optional: true): ComputedRef<Translator> | undefined;
/**
 * Extracts Ajv from JSON Forms
 */
export declare function useAjv(): Ajv;
export declare function useAjv(optional: true): Ajv | undefined;
export {};
