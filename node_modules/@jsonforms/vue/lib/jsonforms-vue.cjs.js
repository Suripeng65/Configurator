...
function useControl(props, stateMap, dispatchMap) {
  ...
  vue.onBeforeMount(function () {
    if (control.value.uischema.scope) {
      id.value = core.Id.createId(control.value.uischema.scope);
    }
  });
  vue.watch(function () {
    return props.schema;
  }, function (newSchema, prevSchem) {
    if (newSchema !== prevSchem && core.isControl(control.value.uischema)) {
      if (id.value) {
        core.Id.removeId(id.value);
      }
      id.value = core.Id.createId(control.value.uischema.scope);
    }
  });
...
function render$2(_ctx, _cache, $props, $setup, $data, $options) {
  return vue.openBlock(), vue.createBlock(vue.resolveDynamicComponent(_ctx.determinedRenderer), vue.normalizeProps(vue.guardReactiveProps(_ctx.renderer)), vue.createSlots({
    _: 2
  }, [vue.renderList(_ctx.$slots, function (_, slotName) {
    return {
      name: slotName,
      fn: vue.withCtx(function () {
        return [vue.renderSlot(_ctx.$slots, slotName)];
      })
    };
  })]), 1040);
}
...
function render$1(_ctx, _cache, $props, $setup, $data, $options) {
  return vue.openBlock(), vue.createBlock(vue.resolveDynamicComponent(_ctx.determinedCell), vue.normalizeProps(vue.guardReactiveProps(_ctx.cell)), vue.createSlots({
    _: 2
  }, [vue.renderList(_ctx.$slots, function (_, slotName) {
    return {
      name: slotName,
