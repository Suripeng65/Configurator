...
export declare const evalReadonly: (uischema: UISchemaElement, data: any, path: string, ajv: Ajv, config: unknown) => boolean;
...
export declare const hasReadonlyRule: (uischema: UISchemaElement) => boolean;
...
export declare const isReadonly: (uischema: UISchemaElement, data: any, path: string, ajv: Ajv, config: unknown) => boolean;
